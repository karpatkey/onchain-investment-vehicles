...
contract UniswapV3PositionVaultRebalanceTest is UniswapV3PositionVaultTestBase {
    ...
    function test_rebalance_movesThePositionAndConsumesAlmostEverything() public {
    ...
    function test_rebalance_holdsOnlyToken1WhenTheRangeSitsBelowThePrice() public {
        _openPosition(200_000e6);
        ...
        vm.prank(curator);
        (,, uint256 amount0, uint256 amount1) = vault.rebalance(lower, upper, 0);
    ...
    function test_rebalance_holdsOnlyToken0WhenTheRangeSitsAboveThePrice() public {
        _openPosition(200_000e6);
    ...
    function test_rebalance_opensAPositionWhenTheVaultHoldsOnlyIdleTokens() public {
    ...
    function test_rebalance_worksFromASingleSidedBalance() public {
        _seedVault(250_000e6, 0);
        (uint256 lower, uint256 upper) = _rangeAroundSpot(1500);

        vm.prank(curator);
        (, uint128 liquidity,, uint256 amount1) = vault.rebalance(lower, upper, 0);
    ...
    function test_rebalance_collectsFeesBeforeMovingTheRange() public {
        _openPosition(200_000e6);
        _accrueFees();
    ...
    function test_rebalance_rejectsAPriceLimitOnTheWrongSide() public {
        _openPosition(200_000e6);
        ...
        vault.rebalance(lower, upper, uint160(uint256(sqrtPriceX96) * 11 / 10));
    }

    function test_rebalance_honoursATighterPriceLimit() public {
        _openPosition(200_000e6);
        ...
        vm.prank(curator);
        (, uint128 liquidity,,) = vault.rebalance(lower, upper, uint160(uint256(sqrtPriceX96) * 9999 / 10_000));
    ...
    function test_rebalance_leavesResidueThatTheNextDepositCompoundsAway() public {
        _openPosition(200_000e6);
        (uint256 lower, uint256 upper) = _shiftedRange(2000, 500);
    ...
    function test_rebalance_keepsShareholdersWholeAcrossTheMove() public {
        _openPosition(200_000e6);
