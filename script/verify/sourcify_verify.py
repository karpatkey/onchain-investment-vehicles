...
TARGET_SETS = {
    ...
    "robinhood-vaults": [
        ...
        ("KPKWETHUSDG100", "/tmp/verif/proxy.json", PROXY_IDENT,
         "0x443Acee79BCF6e7A5E5E4C8f419aeD4Ac0173eA1"),
        ("KPKWETHUSDG500", "/tmp/verif/proxy.json", PROXY_IDENT,
         "0x81313b5F492D56dEB77504cdA0c8e0fa0A7e285f"),
        ("KPKWETHUSDG3000", "/tmp/verif/proxy.json", PROXY_IDENT,
         "0x0e464611bEb25a6D98AFC6122E97D68F948c38Ca"),
        ("KPKWETHUSDG10000", "/tmp/verif/proxy.json", PROXY_IDENT,
         "0xc21Bdf3f5D138b5849E503A2aF13d2651D1d0F38"),
    ],
}
